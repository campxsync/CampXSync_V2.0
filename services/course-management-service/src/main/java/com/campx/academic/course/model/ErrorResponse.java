...
/**
 * Standardized RFC 7807-compliant Error Response model for ACD-01 Course Management Service.
 * Encapsulates structured error information with trace correlation for API responses.
 */
public class ErrorResponse {
    ...
    /**
     * Short HTTP status description or error title.
     */
    ...
    /**
     * URI request path where the error occurred.
     */
    ...
    /**
     * Constructs a new {@code ErrorResponse} instance with the specified error attributes.
     *
    ...
    public ErrorResponse(int status, String error, String errorCode, String message, String path, String traceId) {
        ...
        this.errorCode = errorCode != null ? errorCode : "ACD_ERROR";
    ...
    /**
     * Returns the epoch timestamp in milliseconds when this error occurred.
     *
